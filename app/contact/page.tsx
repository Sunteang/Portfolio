...
export default function ContactPage() {
  ...
  return (
    <div className="max-w-lg mx-auto bg-gray-800 p-8 rounded-lg shadow-lg">
      <h2 className="text-4xl font-bold mb-6 text-center text-yellow-300">
        Contact Me
      </h2>
      {submitted ? (
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full py-3 bg-yellow-500 text-gray-900 font-semibold rounded-full shadow-lg hover:bg-yellow-400 transition duration-300"
          >
            Send Message
          </button>
        </form>
